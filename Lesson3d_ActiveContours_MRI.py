...
#intial contour
#yx_center = [156,279]
#yx_center = [71,309] #other centers
yx_center = [252,241] #other centers
#yx_center = [350,221] #other centers
s = np.linspace(0, 2*np.pi, 2000) #2000 nodes
r = yx_center[0] + 35*np.sin(s)
c = yx_center[1] + 45*np.cos(s)
init = np.array([r, c]).T
...
snake = active_contour(gaussian_filtered_image,
                       init,
                       alpha=1, beta=1, w_line=0, w_edge=1, gamma=0.1,
                       max_num_iter=2000, convergence=0.1)
